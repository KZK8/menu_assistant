...
//一度値を削除する
unset($_SESSION['category'], $_SESSION['eat_date']);
...
<body>
    ...
    <div class="container">
        <form action="./choice_action.php" method="post">
            <input type="date" name="eat_date" value="<?php echo date('Y-m-d') ?>" id="day">
            <label for="day">
                <input type="radio" name="category" value="0" id="wa" checked>
                <label for="wa">和食</label>
                <input type="radio" name="category" value="1" id="you">
                <label for="you">洋食</label>
                <input type="radio" name="category" value="2" id="tyu">
                <label for="tyu">中華</label>
    </div>
    <div class="container mt-4">
        <a href="../../eat_list/eat_history/index.php" class="btn btn-outline-primary">戻る</a>
        <input type="submit" class="btn btn-primary" value="提案ボタン">
        </form>
    </div>
